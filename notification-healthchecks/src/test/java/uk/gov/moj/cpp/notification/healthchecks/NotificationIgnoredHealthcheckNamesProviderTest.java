package uk.gov.moj.cpp.notification.healthchecks;
...
public class NotificationIgnoredHealthcheckNamesProviderTest {

    @InjectMocks
    private NotificationIgnoredHealthcheckNamesProvider notificationIgnoredHealthcheckNamesProvider;

    @Test
    public void shouldIgnoreFileStoreAndJobStoreHealthchecks() throws Exception {

        final List<String> namesOfIgnoredHealthChecks = notificationIgnoredHealthcheckNamesProvider.getNamesOfIgnoredHealthChecks();
