...
@Specializes
public class NotificationIgnoredHealthcheckNamesProvider extends DefaultIgnoredHealthcheckNamesProvider {

    public NotificationIgnoredHealthcheckNamesProvider() {
